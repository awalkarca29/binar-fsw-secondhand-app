    ...
    <div >
      ...
      <div className="mx-20 my-24 p-3 border-0 rounded-lg shadow-lg  flex flex-col lg:w-[1184px] sm:w-[450px] lg:h-[508px] bg-white-normal  outline-none focus:outline-none">
        ...
        <div className='lg:mx-20 lg:my-20 sm:mx-32 sm:my-5 lg:w-[400px] sm:w-40'> 
            ...
            <input type="text" name="text" className="md:w-96 mt-1 sm:mt-5 md:px-3 sm:mb-4 md:py-3 bg-white border shadow-sm border-slate-300 placeholder-black-normal focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" placeholder="name" />
